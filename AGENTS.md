...
## ブランチ運用方針（AI必読）
- このブランチで作業するAIは、着手前に `AI向け_ブランチ方針_ユーザー体感テンポ最優先_2026-04-07.md` を必ず読む
- 作業の大粒度優先順位と現在の全体計画は `AI向け_現在の全体プラン_2026-04-07.md` を正本として確認する
...
- **このブランチで作業する全AIはここも読め！** 👉 [AI向け_ブランチ方針_ユーザー体感テンポ最優先_2026-04-07.md](AI向け_ブランチ方針_ユーザー体感テンポ最優先_2026-04-07.md)
