...
1. `rescue-worker-artifact.yml` の役割を Private repo 運用で十分代替できるか再判断
2. local worker source build opt-in を、数回の安定 release 後にさらに縮退できるか見直す
3. 履歴資料の古い source path 直書きを Public / Private 完成形へ順次置換する
