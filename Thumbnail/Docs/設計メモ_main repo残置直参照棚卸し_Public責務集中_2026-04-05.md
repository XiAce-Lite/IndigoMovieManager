...
- Private repo 側 `scripts\create_rescue_worker_artifact_package.ps1` も、`scripts\private-engine-seed\` を正本にして bootstrap が seed する橋渡し資産である
...
- worker artifact の個別生成は Public root に置かず、Private repo 側の正本導線へ寄せる
