...
- `C:\Users\na6ce\source\repos\IndigoMovieManager\scripts\sync_private_engine_packages.ps1`
...
- 2026-04-05 時点で Public release workflow は worker だけでなく `Contracts / Engine / FailureDb` package も Private release asset / artifact から同期して consume する
