...
Private repo 側の `scripts/create_rescue_worker_artifact_package.ps1` も、`scripts/private-engine-seed/` を正本にしてこの bootstrap が seed する。
2026-04-05 時点では、通常運用の release / publish 入口ではなく、移行 bridge asset として固定する。
